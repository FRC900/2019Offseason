...
class RobotControllerState
{
	public :
		...
		std::string    GetSysActiveStatus(void) const          { return sys_active_status_; }
		...
		void SetSysActiveStatus(std::string sys_active_status)               { sys_active_status_ = sys_active_status; }
